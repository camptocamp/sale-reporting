...
class TestBlanketOrderLinePosition(TransactionCase):
    ...
    def test_unlink_line(self):
        ...
        self.blanket.line_ids[0].unlink()
        self.assertEqual(len(self.order.line_ids), 2)
        self.assertEqual(self.order.line_ids[1].position, 1)
    ...
    def test_unlink_no_recompute_line(self):
        ...
        self.blanket.company_id.disable_sale_position_recompute = True
        self.blanket.line_ids[0].unlink()
        self.assertEqual(len(self.blanket.line_ids), 2)
        self.assertEqual(self.blanket.line_ids[1].position, 2)
